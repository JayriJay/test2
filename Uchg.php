    ...
    <div class="row">
      <nav class="mt-5">
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Save Items</button>
          <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Log Out</button>
      ...
      <div class="tab-content" id="nav-tabContent">
          ...
          <div class="container d-flex justify-content-center">
            <div class="row d-flex justify-content-center">
              <div class="change-password ">
                <h3 class="change_password_title">Change Password</h3>
                <form action="">
                  <p class="mb-2 change-password-p">Old Password</p>
                  <input type="password" name="" id="password" placeholder="Enter old-password" value="">

                  <p class="mt-3 mb-2 change-password-p">New Password</p>
                  <input type="password" name="" id="password" placeholder="Ente new-password" value="">

                  <p class="mt-3 mb-2 change-password-p">Confirm Password</p>
                  <input type="password" name="" id="password" placeholder="Confirm Password" value="">

                  <div class="d-flex justify-content-around mt-3 mb-2">
                    <input type="submit" name="" id="login" value="Save" class="justify-content-start">
                    <input type="reset" name="" id="login" value="Cancle">
                  </div>

                  <div>
                    <a href="user_profile.php" class="back-to d-flex justify-content-center" style="text-decoration: none;">Back To Profile</a>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
          <div class="container">
            <div class="row">
              <div style="border-left: solid 8px  #77E2E1; margin-left: 10px;" class="mb-4 mt-5">
                <h1>Save Items</h1>
              </div>
