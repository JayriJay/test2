...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-md-3 sticky-top" style="border-bottom: 3px solid #ffba00;">
    <div class="container">
      <a class="navbar-brand text-uppercase" href="chg_password.php">Recipe</a>
      ...
      <div class="tab-content" id="nav-tabContent">
            ...
            <div class="row d-flex justify-content-center">
              <div class="change-password ">
                ...
                <form action="">
                  ...
                  <div>
                    <a href="chef_profile.php" class="back-to d-flex justify-content-center" style="text-decoration: none;">Back To Profile</a>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
           <div class="container d-lg-flex justify-content-around mt-5">
              <div class="col-lg-3 col-xs-3 col-md-6 mb-4">
                <img src="image/Gnocchi-pasta-bake.jpg" class="img-fluid shadow"> 
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 border p-3 shadow">
